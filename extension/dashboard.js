...
let logoutBtn, userEmailDisplay, profileBanner, profileBtn, headerActions;
...
/**
 * Update header actions visibility based on auth state
 */
function updateHeaderVisibility() {
  if (authToken && userEmail) {
    ...
    // Hide header actions when logged out
